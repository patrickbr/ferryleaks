...
public class RaphaelJS extends JavaScriptObject {
	...
	protected static class Element extends JavaScriptObject {
		...
		public final native Element animate(JavaScriptObject newAttrs, int ms,
				String easing, AnimationCallback callback) /*-{
		...
		public final native Element animateAlong(Element path, int ms,
				boolean rotate, AnimationCallback callback) /*-{
		...
		public final native Element animateWith(Element element,
				JavaScriptObject newAttrs, int ms) /*-{
													return this.animateWith(element, newAttrs, ms);
													}-*/;

		public final native Element animateWith(Element element,
				JavaScriptObject newAttrs, int ms, AnimationCallback callback) /*-{
		...
		public final native Element animateWith(Element element,
				JavaScriptObject newAttrs, int ms, String easing) /*-{
	 ...
	 */
	static public final native RaphaelJS create(
			com.google.gwt.user.client.Element element, int width, int height) /*-{
	 ...
	 * Raphael factory method
	 */
	static public final native RaphaelJS create(String elementId, int width,
			int height) /*-{
	 ...
	 */
	public final native Element image(String src, double x, double y,
	...
	public final native Font print(double x, double y, String text, Font font,
			double font_size) /*-{
	 ...
	 */
	public final native Element rect(double x, double y, double width,
			double height) /*-{
