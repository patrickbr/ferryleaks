...
/**
 * A GoAble which describes content allowed to hold its own semantic value. Will
 * be parsed to an internal class.
 * 
...
public class Value extends GoInto {
	...
	public Value(String xmlObject, String howOften, String valName,
			String humanName, String nameToPrint, boolean hasVal) {
	 ...
	 * 
	 * @param fields
	 *            the fields to be set as a List
	 */
	...
	/**
	 * Sets the value name of this Value. This is the internal name that will be
	 * given to the actual XML value the XML element described by this
	 * Value-object holds.
	 * 
	 * @param valName
	 *            the value to set.
	...
	public String toString() {
		String ret = "{VAL: name=" + valName + " howOften=" + super.howOften
				+ " XMLob:" + super.xmlObject + " childs:(";
