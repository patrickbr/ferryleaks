...
/**
 * An interface declaring various methods for accessing objects parsed
 * from a schema file
...
public interface GoAble extends IsSerializable  {
	...
	/**
	 * Sets how often the element described by this GoAble is
	 * expected to occur
	 * @param howOften the howoften string (a RegExpression quantifier)
	 */
	...
	/**
	 * Returns the <i>internal</i> name of this field. This is
	 * usually the name of the XML object to be parse
	 * @return the field's internal name
	 */
	public String getInternalName();
	
	/**
	 * Returns the schema of this GoAble, that is the list of
	 * this GoAbles' children
	...
	/**
	 * Returns the XML object name this GoAble will parse. This is
	 * usually the same as getInternalName().
	 ...
	 * @param editable true if this field should be editable
	 */
	public void setEditable(boolean editable);
	
	/**
	 * Returns the name_to_print attribute parsed from the 
	 * schema file
