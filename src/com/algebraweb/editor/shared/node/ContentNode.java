...
public abstract class ContentNode implements IsSerializable{
	...
	public List<NodeContent> getContentWithAttributeValue(String attr, String value) {
	...
	/**
	 * Returns contents in this ContentNode that fit a given scheme.
	 * Stays flat, doet NOT go into content childs!
	 * @param g the scheme to look for
	...
	/**
	 * Return the internal name of this content node. This is usually the
	 * XML object's name.
	...
	/**
	 * Returns the <i>label</i> of this content node. This is the label
	 * built from the information given in the node scheme file.
	 ...
	 * @param con the NodeContent object to remove
