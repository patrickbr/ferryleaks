...
public interface RemoteManipulationService extends RemoteService {
	...
	public void copyNodes(List<PlanNodeCopyMessage> msg, int pid) throws SessionExpiredException, PlanManipulationException;
	public Integer createNewPlan(boolean clearFirst) throws SessionExpiredException;
	public RemoteManipulationMessage deleteEdge(Map<Coordinate, Integer> map,
	...
	public List<Property> getReferencableColumnsWithoutAddedFromPos(int nid, int pid, int pos) throws PlanManipulationException, PlanHasCycleException;
