...
public class ControlPanel extends AbsolutePanel{
	...
	public ControlPanel(AlgebraEditor e,PlanModelManipulator man,int width, int height,final RemoteManipulationServiceAsync rmsa) {
		...
		ControlPanelButton addNodeButton = new ControlPanelButton("Add new node","add");
		...
		ControlPanelButton addEdgeButton = new ControlPanelButton("Add new edge","add-edge");
		...
		ControlPanelButton deleteButton = new ControlPanelButton("Delete selected nod","delete");
		...
		ControlPanelButton editButton = new ControlPanelButton("Edit selected node","edit");
		...
		ControlPanelButton xmlButton = new ControlPanelButton("Get XML for selected node","xml");
		...
		ControlPanelButton xmlPlanButton = new ControlPanelButton("Get XML plan beginning with selected node","xml-down");
		...
		ControlPanelButton sqlButton = new ControlPanelButton("Get SQL","sql-down");
		...
		ControlPanelButton evaluationButton = new ControlPanelButton("Evaluate node","eva");
		...
		ControlPanelButton dotSortButton = new ControlPanelButton("Sort with dot","sort-dot");
		...
		ControlPanelButton sortCircleButton = new ControlPanelButton("circle","sort-circle");
		...
		ControlPanelButton sortLineButton = new ControlPanelButton("line","sort-line");
		...
		ControlPanelButton downloadPlanButton = new ControlPanelButton("Download plan","download-plan");
		...
		ControlPanelButton getSvgButton = new ControlPanelButton("Get SVG of current plan","svg-plan");
		...
		ControlPanelButton uploadButton = new ControlPanelButton("Upload XML plan", "upload");
