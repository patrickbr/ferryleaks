...
/**
 * The CommunicationServiceAsync for the RemoteManipulationService. Calls to
 * these methods will go directly to the servers implementation of the
 * corresponding CommnicationService (RemoteManipulationService)
 * 
 * Try not to access these methods directly. Instead, use the AlgebraEditor or
 * PlanModelManipulater instances where possible.
 * 
